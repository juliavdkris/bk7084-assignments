...
you have to translate these transformations to correct code.
Note: the transformations are not nested, so you can directly use them without using a hierarchy.
